...
- [ ] Did I run a Design Together checkpoint before architecture lock-in?
- [ ] Did I document the selected path with clear trade-offs and rationale?
- [ ] Did I validate quality gate evidence (tests/checks/security/decision log)?
