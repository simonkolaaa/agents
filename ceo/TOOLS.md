...
- For new project setup decisions, always produce 2-3 architecture options before a GO/NO-GO call.
- Include one student-friendly recommendation and one scalability-oriented recommendation.
- Confirm with the user before resource allocation on non-trivial architecture changes.
