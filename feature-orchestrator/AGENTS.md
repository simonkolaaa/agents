...
- Before kicking off implementation, confirm architecture direction with the user.
- Keep communication educational: short explanation of each key phase transition.
- Distinguish required deliverables from optional improvement proposals in every handoff.
