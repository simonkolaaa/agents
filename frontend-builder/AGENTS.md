...
- Adapt implementation explanations to the user's current level (clear, concise, practical).
- If architecture impacts frontend structure, request confirmation before large refactors.
- Keep required scope and optional UI enhancements explicitly separated.
