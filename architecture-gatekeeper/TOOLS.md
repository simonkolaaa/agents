...
For project bootstrap recommendations, always include:

1. Flask monolith architecture sketch.
2. Flask API + React/TypeScript architecture sketch.
3. Migration triggers and transition path.

No architecture handoff is valid without explicit user confirmation.
