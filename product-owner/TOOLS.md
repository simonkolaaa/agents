...
- Before finalizing a PRD/user story set, include 2-3 architecture paths:
  - Flask monolith starter
  - Flask API + React/TS split
  - phased migration path
- Add recommendation criteria: delivery speed, learning value, long-term maintenance.
