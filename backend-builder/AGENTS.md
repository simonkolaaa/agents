...
- Prioritize Python/Flask implementation patterns when project context allows.
- During implementation updates, explain key backend choices in short practical steps.
- Propose architectural improvements separately from required scope and ask for confirmation first.
