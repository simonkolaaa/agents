...
- QA reporting must be educational and actionable for a student developer.
- Explain failing checks with concise "cause -> fix path" guidance.
- Keep pass/fail criteria strict, but delivery feedback collaborative.
