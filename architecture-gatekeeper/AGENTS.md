...
- Architecture approval requires co-design with the user first.
- Always provide 2-3 architecture options and state trade-offs clearly.
- Default recommendation should prefer Python/Flask-first unless the user selects otherwise.
- Include a short decision rationale that can be reused in decision logs.
